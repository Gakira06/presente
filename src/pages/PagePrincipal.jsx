  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center px-4 py-12">
        ...
        {/* Special Message */}
        <h1 className="text-center font-bold font-serif text-5xl mb-6">
          Para minha
          <br />
          Princesa
        </h1>
        ...
        <div className="flex gap-4 mb-8">
          {[
            ...
            >
              <span className="text-3xl font-bold text-pink-400">{valor}</span>
        ...
        >
          {musicaEstado === "revelada" ? (
            ...
            <>
              ...
              <h2 className="text-center font-bold font-serif text-2xl mb-2">
                Nossa Música
              </h2>
        ...
        <section className="w-full max-w-sm mb-16">
          <h2 className="text-center font-bold font-serif text-5xl mb-3">
            Nossos Momentos
          </h2>
